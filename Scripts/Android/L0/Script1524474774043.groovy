...
Mobile.setText(findTestObject('android.widget.EditText0 - Isi namamu'), 'pandu buana kurniawan', 0)

Mobile.hideKeyboard()

Mobile.setText(findTestObject('android.widget.EditText1 - Isi nomor teleponmu'), '085774853134', 0)

Mobile.hideKeyboard()

Mobile.setText(findTestObject('android.widget.EditText2 - Isi alamat emailmu'), 'testerautomation@mailinator.com', 0)
